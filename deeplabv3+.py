...
class SegDataset(gluon.data.Dataset):
    ...
    def label_indices(self, img):
        ...
        #print "id ",self.colormap2label[idx]
...
filename2 = 'VOC_less2.params'
net.load_params(filename2, ctx=ctx)
import time
